Profile: NlcoreHearingFunctionHearingAidProduct
Parent: http://nictiz.nl/fhir/StructureDefinition/nl-base-HearingFunction.HearingAid.Product
Id: nl-core-HearingFunction.HearingAid.Product
Title: "nl core HearingFunction.HearingAid.Product"
* insert ProfileMetadata(nl-core-HearingFunction.HearingAid.Product)
...
* ^description = """
    ...
    """
* . ^alias[+] = "nl-core-HearingFunction.HearingAid.Product"
