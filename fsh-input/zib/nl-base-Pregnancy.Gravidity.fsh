Profile: NlbasePregnancyGravidity
Parent: Observation
Id: nl-base-Pregnancy.Gravidity
Title: "nl base Pregnancy.Gravidity"
* insert ProfileMetadata(nl-base-Pregnancy.Gravidity)
...
* code = http://snomed.info/sct#161732006
...
* . ^comment = "This profile on the Observation resource represents the Gravidity concept (NL-CM:7.14.5) of zib Pregnancy. It can be used together with the [nl-base-Pregnancy](http://nictiz.nl/fhir/StructureDefinition/nl-base-Pregnancy) profile on the Observation resource, which groups references to the current and other resources on `Observation.hasMember`."
* valueInteger
  * ^short = "Gravidity"
  * ^alias[+] = "Graviditeit"
  * ^definition = "The number of times the woman has gotten pregnant (including this one)."

Mapping: NlbasePregnancyGravidity-to-zib-pregnancy-v4.0-2020EN
Id: zib-pregnancy-v4.0-2020EN
Title: "zib Pregnancy-v4.0(2020EN)"
Source: NlbasePregnancyGravidity
Target: "https://zibs.nl/wiki/Pregnancy-v4.0(2020EN)"
* valueInteger -> "NL-CM:7.14.5" "Gravidity"
