Profile: NlcoreVisualFunctionVisualAidProduct
Parent: http://nictiz.nl/fhir/StructureDefinition/nl-base-VisualFunction.VisualAid.Product
Id: nl-core-VisualFunction.VisualAid.Product
Title: "nl core VisualFunction.VisualAid.Product"
...
* ^description = """
    ...
    """
* . ^alias[+] = "nl-core-VisualFunction.VisualAid.Product"
