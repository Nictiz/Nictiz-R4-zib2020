Profile: NlbasePulseRate
Parent: http://nictiz.nl/fhir/StructureDefinition/pattern-VitalSigns
Id: nl-base-PulseRate
Title: "nl base PulseRate"
* insert ProfileMetadata(nl-base-PulseRate)
* insert Purpose(PulseRate, 3.3, Observation)

* code = http://snomed.info/sct#366199006
* effective[x] insert Discriminator(type, $this)
* effectiveDateTime only dateTime
* hasMember insert Discriminator(profile, resolve(\))
* hasMember contains
    pulseRateValue 0..1 and
    pulseRegularity 0..1
* hasMember[pulseRateValue] only Reference(http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate.PulseRateValue)
* hasMember[pulseRegularity] only Reference(http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate.PulseRegularity)
...
* .
  ...
  * ^comment = """
    ...
    * PulseRateValue (NL-CM:12.7.2): [nl-base-PulseRate.PulseRateValue](http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate.PulseRateValue)
    * PulseRegularity (NL-CM:12.7.5): [nl-base-PulseRate.PulseRegularity](http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate.PulseRegularity)
    """
* effectiveDateTime
  * ^short = "PulseRateDateTime"
  * ^alias[+] = "PolsfrequentieDatumTijd"
...
* hasMember[pulseRateValue] ^definition = "The PulseRateValue concept (NL-CM:12.7.2) of zib PulseRate, represented as a distinct Observation resource."
* hasMember[pulseRegularity] ^definition = "The PulseRegularity concept (NL-CM:12.7.5) of zib PulseRate, represented as a distinct Observation resource."

Mapping: NlbasePulseRate-to-zib-pulserate-v3.3-2020EN
Id: zib-pulserate-v3.3-2020EN
Title: "zib PulseRate-v3.3(2020EN)"
Source: NlbasePulseRate
Target: "https://zibs.nl/wiki/PulseRate-v3.3(2020EN)"
*  -> "NL-CM:12.7.1" "PulseRate"
* effectiveDateTime -> "NL-CM:12.7.3" "PulseRateDateTime"
* note.text -> "NL-CM:12.7.4" "Comment"
