Profile: NlcorePulseRatePulseRegularity
Parent: http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate.PulseRegularity
...
* .
  * ^alias[+] = "nl-core-PulseRate.PulseRegularity"
  * ^comment = """
