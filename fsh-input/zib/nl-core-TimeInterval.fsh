Profile: NlcoreTimeInterval
Parent: http://nictiz.nl/fhir/StructureDefinition/nl-base-TimeInterval
Id: nl-core-TimeInterval
Title: "nl core TimeInterval"
* insert ProfileMetadata(nl-core-TimeInterval)
