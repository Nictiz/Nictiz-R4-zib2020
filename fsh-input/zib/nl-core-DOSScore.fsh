...
* component[dozesOff].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[easilyDistracted] ..1
* component[easilyDistracted].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[maintainsAttention] ..1
* component[maintainsAttention].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[unfinishedQuestionAnswer] ..1
* component[unfinishedQuestionAnswer].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[answersNoFit] ..1
* component[answersNoFit].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[reactsSlowly] ..1
* component[reactsSlowly].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[thinksSomewhereElse] ..1
* component[thinksSomewhereElse].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[knowsPartDay] ..1
* component[knowsPartDay].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[remembersRecent] ..1
* component[remembersRecent].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[restless] ..1
* component[restless].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[pullsWires] ..1
* component[pullsWires].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[easilyEmotional] ..1
* component[easilyEmotional].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
* component[hallucinations] ..1
* component[hallucinations].valueInteger
  * ^minValueInteger = 0
  * ^maxValueInteger = 1
