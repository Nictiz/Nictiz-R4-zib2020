Profile: NlbaseDevelopmentChildDevelopmentSocial
Parent: Observation
Id: nl-base-DevelopmentChild.DevelopmentSocial
Title: "nl base DevelopmentChild.DevelopmentSocial"
* insert ProfileMetadata(nl-base-DevelopmentChild.DevelopmentSocial)
...
* code = http://snomed.info/sct#225597007
* effective[x] insert Discriminator(type, $this)
* effectiveDateTime only dateTime
* value[x] only CodeableConcept
* value[x] from http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.40.2.4.32.4--20200901000000 (preferred)
...
* value[x]
  * ^short = "DevelopmentSocial"
  * ^alias[+] = "OntwikkelingSociaal"
  * ^definition = "Milestones of social development of a child."

Mapping: NlbaseDevelopmentChildDevelopmentSocial-to-zib-developmentchild-v1.2-2020EN
Id: zib-developmentchild-v1.2-2020EN
Title: "zib DevelopmentChild-v1.2(2020EN)"
Source: NlbaseDevelopmentChildDevelopmentSocial
Target: "https://zibs.nl/wiki/DevelopmentChild-v1.2(2020EN)"
* effectiveDateTime -> "NL-CM:4.32.2" "DevelopmentChildDateTime"
* value[x] -> "NL-CM:4.32.8" "DevelopmentSocial"
