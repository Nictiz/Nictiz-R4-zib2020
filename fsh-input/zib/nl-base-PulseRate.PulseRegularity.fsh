Profile: NlbasePulseRatePulseRegularity
Parent: http://nictiz.nl/fhir/StructureDefinition/pattern-VitalSigns
Id: nl-base-PulseRate.PulseRegularity
Title: "nl base PulseRate.PulseRegularity"
* insert ProfileMetadata(nl-base-PulseRate.PulseRegularity)
...
* code = http://loinc.org#44969-4
* effective[x] insert Discriminator(type, $this)
* effectiveDateTime only dateTime
* value[x] only CodeableConcept
* value[x] from http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.40.2.12.7.1--20200901000000 (preferred)
...
* . ^comment = """
    ...
    **Multiple profiles to represent the zib**
    ...
    This Observation resource represents the PulseRegularity concept (NL-CM:12.7.5) of zib PulseRate. It can be used together with the [nl-base-PulseRate](http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate) profile on the Observation resource, which groups references to the current and other resources on `Observation.hasMember`.
    """
* effectiveDateTime
