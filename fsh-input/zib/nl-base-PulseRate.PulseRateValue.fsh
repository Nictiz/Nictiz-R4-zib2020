Profile: NlbasePulseRatePulseRateValue
Parent: http://nictiz.nl/fhir/StructureDefinition/pattern-VitalSigns
Id: nl-base-PulseRate.PulseRateValue
Title: "nl base PulseRate.PulseRateValue"
* insert ProfileMetadata(nl-base-PulseRate.PulseRateValue)
...
* . ^comment = """
    ...
    **Multiple profiles to represent the zib**
    ...
    This Observation resource represents the PulseRateValue concept (NL-CM:12.7.2) of zib PulseRate. It can be used together with the [nl-base-PulseRate](http://nictiz.nl/fhir/StructureDefinition/nl-base-PulseRate) profile on the Observation resource, which groups references to the current and other resources on `Observation.hasMember`.
    """
* effectiveDateTime
