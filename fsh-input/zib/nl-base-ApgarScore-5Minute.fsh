Profile: NlbaseApgarScore5Minute
Parent: Observation
Id: nl-base-ApgarScore-5Minute
Title: "nl base ApgarScore 5Minute"
* insert ProfileMetadata(nl-base-ApgarScore-5Minute)
...
* component contains
    ...
    muscleToneScore 0..1
* component[respiratoryScore].code = http://loinc.org#32415-2
...
* component[appearanceScore].code = http://loinc.org#32411-1
...
* component[pulseScore].code = http://loinc.org#32412-9
...
* component[grimaceScore].code = http://loinc.org#32414-5
...
* component[muscleToneScore].code = http://loinc.org#32413-7
...
Mapping: NlbaseApgarScore5Minute-to-zib-apgarscore-v1.0.1-2020EN
Id: zib-apgarscore-v1.0.1-2020EN
Title: "zib ApgarScore-v1.0.1(2020EN)"
Source: NlbaseApgarScore5Minute
