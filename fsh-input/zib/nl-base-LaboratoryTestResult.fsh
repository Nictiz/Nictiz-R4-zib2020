...
* status from http://hl7.org/fhir/ValueSet/observation-status|4.0.1 (preferred)
...
* interpretation[resultFlags] from http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.40.2.13.1.7--20200901000000 (preferred)
