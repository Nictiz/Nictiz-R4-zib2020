Profile: NlbaseDevelopmentChildToiletTrainednessFeces
Parent: Observation
Id: nl-base-DevelopmentChild.ToiletTrainednessFeces
Title: "nl base DevelopmentChild.ToiletTrainednessFeces"
* insert ProfileMetadata(nl-base-DevelopmentChild.ToiletTrainednessFeces)
...
* code = http://snomed.info/sct#275818006
* effective[x] insert Discriminator(type, $this)
* effectiveDateTime only dateTime
* value[x] only CodeableConcept
* value[x] from http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.40.2.4.32.2--20200901000000 (preferred)
...
* value[x]
  * ^short = "ToiletTrainednessFeces"
  * ^alias[+] = "ZindelijkheidFeces"
  * ^definition = "Degree of toilet trainedness for feces."

Mapping: NlbaseDevelopmentChildToiletTrainednessFeces-to-zib-developmentchild-v1.2-2020EN
Id: zib-developmentchild-v1.2-2020EN
Title: "zib DevelopmentChild-v1.2(2020EN)"
Source: NlbaseDevelopmentChildToiletTrainednessFeces
Target: "https://zibs.nl/wiki/DevelopmentChild-v1.2(2020EN)"
* effectiveDateTime -> "NL-CM:4.32.2" "DevelopmentChildDateTime"
* value[x] -> "NL-CM:4.32.5" "ToiletTrainednessFeces"
