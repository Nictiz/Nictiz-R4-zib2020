Profile: NlbaseApgarScore10Minute
Parent: Observation
Id: nl-base-ApgarScore-10Minute
Title: "nl base ApgarScore 10Minute"
* insert ProfileMetadata(nl-base-ApgarScore-10Minute)
* insert Purpose(ApgarScore, 1.0.1, Observation)

* code = http://loinc.org#9271-8
...
* component contains
    ...
    muscleToneScore 0..1
* component[respiratoryScore].code = http://loinc.org#32405-3
...
* component[appearanceScore].code = http://loinc.org#32401-2
...
* component[pulseScore].code = http://loinc.org#32402-0
...
* component[grimaceScore].code = http://loinc.org#32404-6
...
* component[muscleToneScore].code = http://loinc.org#32403-8
...
Mapping: NlbaseApgarScore10Minute-to-zib-apgarscore-v1.0.1-2020EN
Id: zib-apgarscore-v1.0.1-2020EN
Title: "zib ApgarScore-v1.0.1(2020EN)"
Source: NlbaseApgarScore10Minute
