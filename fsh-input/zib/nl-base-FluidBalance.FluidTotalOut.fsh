Profile: NlbaseFluidBalanceFluidTotalOut
Parent: Observation
Id: nl-base-FluidBalance.FluidTotalOut
Title: "nl base FluidBalance.FluidTotalOut"
* insert ProfileMetadata(nl-base-FluidBalance.FluidTotalOut)
...
* code = http://snomed.info/sct#251841007
...
Mapping: NlbaseFluidBalanceFluidTotalOut-to-zib-fluidbalance-v1.0.1-2020EN
Id: zib-fluidbalance-v1.0.1-2020EN
Title: "zib FluidBalance-v1.0.1(2020EN)"
Source: NlbaseFluidBalanceFluidTotalOut
...
* value[x] -> "NL-CM:12.15.5" "FluidTotalOut"
