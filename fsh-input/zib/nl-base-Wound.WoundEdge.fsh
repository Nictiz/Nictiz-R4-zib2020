Profile: NlbaseWoundWoundEdge
Parent: Observation
Id: nl-base-Wound.WoundEdge
Title: "nl base Wound.WoundEdge"
* insert ProfileMetadata(nl-base-Wound.WoundEdge)
...
* code = http://snomed.info/sct#449747006
* value[x] only CodeableConcept
* value[x] from http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.40.2.19.2.5--20200901000000 (preferred)

// Short, alias, definition and comment texts
* ^description = "Description of the condition of the outer edges of the wound."
* . ^comment = "This Observation resource represents the WoundEdge concept (NL-CM:19.2.11) of zib Wound. It is usually part of an assessment, which is represented using the [nl-base-wounds.WoundCharacteristics](http://nictiz.nl/fhir/StructureDefinition/nl-base-wounds.WoundCharacteristics) profile. See the comment on the root of that profile for guidance on using this resource."
* value[x]
  * ^short = "WoundEdge"
  * ^alias[+] = "WondRand"
  * ^definition = "Description of the condition of the outer edges of the wound."

Mapping: NlbaseWoundWoundEdge-to-zib-wound-v3.3-2020EN
Id: zib-wound-v3.3-2020EN
Title: "zib Wound-v3.3(2020EN)"
Source: NlbaseWoundWoundEdge
Target: "https://zibs.nl/wiki/Wound-v3.3(2020EN)"
* value[x] -> "NL-CM:19.2.11" "WoundEdge"
